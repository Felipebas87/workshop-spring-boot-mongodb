...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2023"), "Férias", "muito boa a viagem", maria );
		Post post2 = new Post(null, sdf.parse("01/06/2023"), "Bom dia", "Acordei feliz hoje!", alex );
